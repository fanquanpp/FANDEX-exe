...
> 跨模块引用：排序算法的复杂度分析依赖于 [[algorithm/overview|算法分析基础]] 中的渐进符号体系。
---
## 2. 冒泡排序
### 2.1 问题描述
...
> 跨模块引用：堆排序的sift-down操作参见下文第7节。快速排序的分区思想也用于快速选择算法，参见 [[algorithm/searching|搜索算法]]。
---
## 6. 归并排序
### 6.1 问题描述
...
> 跨模块引用：堆是优先队列的底层实现，参见 [[algorithm/tree|树结构]] 中关于堆的详细讨论。
---
## 8. 非比较排序
### 8.1 计数排序
适用于元素范围为有限整数的情况。
...
> 跨模块引用：排序算法在搜索预处理中广泛应用，参见 [[algorithm/searching|搜索算法]]。C++ STL排序实现参见 [[cpp/overview|C++基础]]。
