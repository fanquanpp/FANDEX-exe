...
> 跨模块参考：[[python/overview|Python 基础]] 是数据分析的编程基础，[[mysql/overview|MySQL]] 是数据获取的重要来源。
---
## 2. 数据分析流程
### 2.1 完整流程图
...
- 内部数据库（需要 [[mysql/overview|MySQL]] 等 SQL 技能）
...
- 理解向量化操作与循环的性能差异
前置知识：[[python/overview|Python 基础]]，特别是列表、字典、函数、模块导入
**阶段二：可视化**
学完此阶段，你应该能够：
